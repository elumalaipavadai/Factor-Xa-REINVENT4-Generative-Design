"""
STEP 06B: Score prior-generated REINVENT molecules with the Factor Xa RF model.
...
Input
-----
data/generated/reinvent_prior_1000.csv
...
results/tables/reinvent_prior_1000_top50_fxa.csv
...
OUT_TOP50 = (
    ...
    / "results"
    / "tables"
    / "reinvent_prior_1000_top50_fxa.csv"
)
...
OUT_JSON = (
    ...
    / "results"
    / "metrics"
    / "reinvent_prior_1000_score_summary.json"
)
...
def main():
    print("=" * 90)
    print("STEP 06B: SCORE PRIOR-GENERATED MOLECULES WITH FACTOR XA RF MODEL")
    print("=" * 90)
